...
<div style='float:left; width:570px;'>
    ...
    ?>
    <br clear="all" />
    <div id='chart-container-<?php echo $bottomStat?>' style='width:550px; height:700px;'></div>
</div>
<div style='float:left; width:570px; margin-left: 2em;'>
    ...
    ?>
    <br clear="all" />
    <div id='chart-container-wzorzec-<?php echo $bottomStat?>' style='width:550px; height:600px;'></div>
</div>
<br clear="all" />
