...
<head>
    ...
    <script type="text/javascript" src="<?php echo $tplData['chartDataPath']?>summaryData.js?0649"></script>
    <script type="text/javascript" src="<?php echo $tplData['chartDataPath']?>questionsData.js?0331"></script>
    <script type="text/javascript" src="<?php echo $tplData['chartDataPath']?>filterSets.js?0331"></script>
